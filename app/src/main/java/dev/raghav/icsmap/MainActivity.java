...
import dev.raghav.icsmap.Scheduler.DemoJobService;
import dev.raghav.icsmap.Scheduler.JobForm;
import dev.raghav.icsmap.services.ConnectivityReceiver;
...
//*****************************
        ...
        Thnaks = findViewById(R.id.thank);
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                   ;
                    startForegroundService(new Intent(getApplicationContext() , LocationMonitoringService1.class));
                }else{
                    Toast.makeText(MainActivity.this, "gonna stop setrvice", Toast.LENGTH_SHORT).show();
                   // stopService(new Intent(getApplicationContext() , LocationMonitoringService.class));
                    startService(new Intent(getApplicationContext() , LocationMonitoringService1.class));
                }
            }
        });
        manager =new SessionManager(MainActivity.this);
        Toast.makeText(this, "sdgdfgdfgdfg", Toast.LENGTH_SHORT).show();
...
//                                jobDispatcher
//                                        .newJobBuilder()
//                                        .setTag("Location tracker")
//                                        .setRecurring(true)
//                                        .setLifetime( Lifetime.FOREVER ).setTrigger(Trigger.executionWindow(30,60))
//                                        .setService( LocationMonitoringService.class).setReplaceCurrent(true)
//                                        .setRetryStrategy(
...
//           new FirebaseJobDispatcher(new GooglePlayDriver(getApplicationContext()));
         Job.Builder builder =
                jobDispatcher
                        ...
                        .setTag("Location tracker")
                        .setRecurring(true)
                        .setLifetime( Lifetime.FOREVER ).setTrigger(Trigger.executionWindow(30,500))
                        .setService(LocationMonitoringService.class).setReplaceCurrent(true)
                        .setRetryStrategy(
                                RetryStrategy.DEFAULT_LINEAR);
        Log.i("FJD.JobForm", "scheduling new job");
...
//                            .setTag("Location tracker")
//                            .setRecurring(true)
//                            .setLifetime(Lifetime.FOREVER).setTrigger(Trigger.executionWindow(1 * 1, 20 * 60))
...
//        {
//            Toast.makeText(this, "iasfhdias", Toast.LENGTH_SHORT).show();
//        }
    }
