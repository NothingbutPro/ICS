...
import static dev.raghav.icsmap.MainActivity.Thnaks;
import static dev.raghav.icsmap.MainActivity.mMsgView;


public class LocationMonitoringService1 extends Service implements
    ...
    private void sendMessageToUI(String lat, String lng) {
        ...
        //Toast.makeText(getApplicationContext(),"latilong"+lat+lng,Toast.LENGTH_SHORT).show();
        //************************************************
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if (!res.equals("true")) {
                    ...
                    Thnaks.setText("Attendance send successfully");
                    stopSelf();
