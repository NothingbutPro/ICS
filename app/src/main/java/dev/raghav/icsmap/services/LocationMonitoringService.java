...
import dev.raghav.icsmap.SplashActivity;
...
// Use like this:
        try {
            ...
            Toast.makeText(this, "foreground is"+foregroud, Toast.LENGTH_LONG).show();
            if(foregroud == false)
            {
//                Intent ix = new Intent(getApplicationContext() , SplashActivity.class);
